    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="admin.php?action=add_product_cate""><i class="fa fa-circle-o"></i> Add product categories</a></li>
            <li><a href="admin.php?action=list_productcate""><i class="fa fa-circle-o"></i> List product categories</a></li>
          </ul>
        </li>
		  <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="admin.php?action=home""><i class="fa fa-circle-o"></i> News </a></li>
           <li><a href="admin.php?action=list_productcate""><i class="fa fa-circle-o"></i> List product categories</a></li>
          </ul>
        </li>
      </ul>
