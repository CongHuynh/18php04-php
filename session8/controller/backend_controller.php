<?php 
	...
	include	'model/product_cate.php';
		...
		function handleRequest() {
			...
			switch ($action) {
				...
				case 'edit_product':
					...
					if(isset($_POST['add_productcate'])) {
						$name     = $_POST['name'];
						$productcateModel = new Productcate();
						$productcateModel->InsertProductcate($name);
						header("Location: admin.php?action=list_productcate");
					}
					include 'view/backend/add_product_cate.php';
				case 'login':
					//view du lieu
